...
!function () {
  ...
  try {
    var t = getCurrentPages(),
        a = JSON.parse(JSON.stringify(t[t.length - 1].options));
...
try {
  var oldSetNavigationBarTitle = jd.setNavigationBarTitle;
...
_.setRefPage = function () {
  ...
  if (_.compareSDKVersion(wxSDKVersion, "2.10.0") >= 0) e.timeout = sa.para.datasend_timeout, jd.request(e);else {
    var t = jd.request(e);
    setTimeout(function () {
  ...
  var e;
  if (jd.getAccountInfoSync && (e = jd.getAccountInfoSync()), _.isObject(e) && _.isObject(e.miniProgram)) return e.miniProgram.appId;
  ...
  if (!_.isObject(e)) return !1;
  var a = e;
  _.isString(e) && ((e = {})[a] = 1), sa.prepareData({
  ...
  this.hasInit = !0, sa.setPara(e), sa.para.encrypt_storage && this.store.encryptStorage(), sa.para.batch_send && (jd.getStorage({
  ...
  var a,
      ...
      i = r[3] || "",
      o = "",
      c = sa.store.getDistinctId() || "",
      u = sa.store.getFirstId() || "";
...
sa.autoTrackCustom = {
  ...
  appLaunch: function (e, t) {
    ...
    var a = {};
    e && e.scene ? (current_scene = e.scene, a.$scene = _.getMPScene(e.scene)) : a.$scene = "\u672a\u53d6\u5230\u503c", e && e.scene && 1010 === e.scene && e.query && (e.query.sampshare && delete e.query.sampshare, _.delObjectKey(e.query)), e && e.path && (a.$url_path = _.getPath(e.path), !0 === sa.para.preset_properties.url_path && sa.registerApp({
      $url_path: a.$url_path
    })), _.setShareInfo(e, a);
  ...
  appShow: function (e, t) {
    var a = {};
    mpshow_time = new Date().getTime(), e && e.scene ? (current_scene = e.scene, a.$scene = _.getMPScene(e.scene)) : a.$scene = "\u672a\u53d6\u5230\u503c", e && e.scene && 1010 === e.scene && e.query && (e.query.sampshare && delete e.query.sampshare, _.delObjectKey(e.query)), e && e.path && (a.$url_path = _.getPath(e.path), !0 === sa.para.preset_properties.url_path && sa.registerApp({
      $url_path: a.$url_path
    })), !_.isObject(sa.para.preset_properties.location) || "wgs84" !== sa.para.preset_properties.location.type && "gcj02" !== sa.para.preset_properties.location.type || sa.getLocation(), _.setShareInfo(e, a);

    var r = _.setUtm(e, a);

    _.setLatestChannel(r.pre2), _.setSfSource(e, a), _.setPageRefData(a), sa.registerApp({
      $latest_scene: a.$scene
    }), a.$url_query = _.setQuery(e.query), t ? (a = _.extend(a, t), sa.track("$MPShow", a)) : sa.para.autoTrack && sa.para.autoTrack.appShow && sa.autoTrackCustom.trackCustom("appShow", a, "$MPShow");
  },
  appHide: function (e) {
  ...
  is_first_launch ? (a.$is_first_time = !0, _.isEmptyObject(r.pre1) || sa.setOnceProfile(r.pre1)) : a.$is_first_time = !1, _.setLatestChannel(r.pre2), _.setSfSource(e, a), sa.registerApp({
    $latest_scene: a.$scene
  }), a.$url_query = _.setQuery(e.query), _.setPageRefData(t), _.isObject(t) && (a = _.extend(a, t)), sa.track("$MPLaunch", a);
  ...
  _.setLatestChannel(r.pre2), _.setSfSource(e, a), sa.registerApp({
    $latest_scene: a.$scene
  }), a.$url_query = _.setQuery(e.query), _.setPageRefData(a), _.isObject(t) && (a = _.extend(a, t)), sa.track("$MPShow", a);
  ...
  !0 === sa.para.preset_properties.url_path && sa.registerApp({
    $url_path: a
  }), r && (t.$title = r), t.$url_path = a, t.$url_query = s.sensors_mp_url_query ? s.sensors_mp_url_query : "", t = _.extend(t, _.getUtmFromPage()), _.setPageSfSource(t), _.setPageRefData(t), _.isObject(e) && (t = _.extend(t, e)), sa.track("$MPViewScreen", t);
};
var oldApp = App;
App = function (e) {
  e[sa.para.name] = sa, oldApp.apply(this, arguments);
}, jd.onAppShow(function (e) {
  if (!sa.para.launched) {
    var t = jd.getLaunchOptionsSync() || {};
