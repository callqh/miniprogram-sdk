    ...
    (() => {
      ...
      var __webpack_modules__ = {
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          const __WEBPACK_DEFAULT_EXPORT__ = wx;
          /***/
        },
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          class Reporter {
            ...
            track(type, data) {
              // 请求延时时间
              const delay = _store__WEBPACK_IMPORTED_MODULE_0__["default"].get('config').request_delay;
            ...
            _flush() {
              const config = _store__WEBPACK_IMPORTED_MODULE_0__["default"].get('config'); // 队列中有数据时进行请求
              ...
              if (this.queue.length > 0) {
                ...
                _platform__WEBPACK_IMPORTED_MODULE_2__["default"].request({
                  ...
                  // TODO 是否需要在发送失败的时候将该次信息保存的storage中？
                  success: () => {},
                  fail: ({
                    errMsg
                  }) => {
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          const defaultConfig = {
            // 后端地址
            url: 'https://analytics.terminus.io/collect',
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          const appLaunch = oldOnLunch => proxyHooks(oldOnLunch, function () {
            (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getNetworkType)(data => {
              _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('networkType', data.networkType);

              (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getSystemInfo)(data => {
                data = {
                  t: 'device',
                  ...data
                };
                autoTrack.appLaunch && _reporter__WEBPACK_IMPORTED_MODULE_1__["default"].track(data);
              });
            });
          });

          const appShow = oldOnShow => proxyHooks(oldOnShow, function () {});

          const appHide = oldOnHide => {
            const ctx = undefined;
            proxyHooks(oldOnHide, function () {});
          };
          /** ====================Page事件代理======================== */
          ...
          const pageShow = oldOnShow => proxyHooks(oldOnShow, function () {
            const time = Date.now();

            _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('pageShowTime', time); // TODO


            const data = {
              t: 'document',
              dt: (0, _utils__WEBPACK_IMPORTED_MODULE_0__.getPageTitle)(this.route) + '',
              dl: this.route,
              tp: time
            };
          });
          ...
          const pageHide = oldOnHide => proxyHooks(oldOnHide, function () {
            // 记录页面停留时间
            const pageStayTime = getPageStayTime(); // TODO
          ...
          const pageUnLoad = oldOnUnLoad => proxyHooks(oldOnUnLoad, function () {
            const pageStayTime = getPageStayTime();
            const data = {
              type: 'pageUnload',
              route: this.route,
              pageStayTime
          ...
          function proxyHooks(fn = function () {}, cb) {
            return function () {
              // 如果回调存在
              if (cb) {
                const name = fn.name;
                cb.apply(this, [arguments, name]);
              } // 执行原函数
          ...
          function getPageStayTime() {
            const pageShowTime = _store__WEBPACK_IMPORTED_MODULE_2__["default"].get('pageShowTime'); // 记录页面停留时间
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          class Tracker {
            ...
            init(config) {
              // 初始化相关配置
              if (config !== undefined) _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('config', config); // 获取用户系统信息

              (0, _utils__WEBPACK_IMPORTED_MODULE_3__.getSystemInfo)(data => {
                _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('systemInfo', data);
              });

              _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('pageShowTime', Date.now()); // 生成用户uuid
              ...
              App = options => this._collector.App(this._proxyAppOptions(options)); // 重写Page方法
            ...
            _proxyAppOptions(options) {
              const autoTrack = _store__WEBPACK_IMPORTED_MODULE_2__["default"].get('config').autoTrack; // 向App中注入手动埋点的方法
              ...
              options.onShow = (0, _hooks__WEBPACK_IMPORTED_MODULE_0__.appShow)(options.onShow); // // onHide 事件监听
            ...
            _proxyPageOptions(options) {
              const autoTrack = _store__WEBPACK_IMPORTED_MODULE_2__["default"].get('config').autoTrack; // 处理生命周期
            ...
            login(uid) {
              _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('uid', uid);
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          const getUserIpAddress = () => _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].request({
          ...
          const getAppId = () => {
            const info = _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].getAccountInfoSync();
          ...
          function getSystemInfo(callback) {
            ...
            _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].getSystemInfo({
              success(res) {
                ...
                if (res) {
                  _data.osn = system[0]; // 操作系统名称

                  _data.osv = system[1]; // 操作系统版本

                  _data.br = res.brand; //设备品牌

                  _data.md = res.model; // 设备型号。新机型刚推出一段时间会显示unknown，微信会尽快进行适配

                  _data.SDKVersion = res.SDKVersion; // 微信客户端基础库版本

                  _data.sr = `${res.screenWidth}x${res.screenHeight}`; // 屏幕分辨率
                }
              },

              complete() {
                // _data.appId = getAppId(); // 设置AppID
                callback && callback(_data); // 执行回调
              }
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          function getPageTitle(route) {
            ...
            try {
              ...
              if (__wxConfig) {
                const routeConfigList = __wxConfig.page || {}; // 当前页面的所有配置

                const current_page_config = routeConfigList[route].window; // 返回当前页面标题
        ...
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          const storage = {
            ...
            set: (key, data) => {
              ...
              _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].setStorageSync(key, data);
            },
            ...
            get: key => {
              key = prefix + key;
              return _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].getStorageSync(key);
            },
            ...
            remove: key => {
              ...
              _src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].removeStorageSync(key);
            }
          };
          /***/
        },
