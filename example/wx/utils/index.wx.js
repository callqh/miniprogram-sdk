...
class Store {
	constructor() {
		this.store = {
			config: _defaultConfig__WEBPACK_IMPORTED_MODULE_0__.defaultConfig, //	用户配置
			systemInfo: {}, // 用户系统信息
		};
	}
	/**
...
/** ====================App事件代理======================== */
const appLaunch = oldOnLunch =>
	proxyHooks(oldOnLunch, function () {
 ...
 * @returns
 */
const pageShow = oldOnShow =>
	proxyHooks(oldOnShow, function () {
		const time = Date.now();
 ...
 */
const pageUnLoad = oldOnUnLoad =>
	proxyHooks(oldOnUnLoad, function () {
		const pageStayTime = getPageStayTime();
		const data = {
			type: 'pageUnload',
			route: this.route,
...
class Tracker {
	...
	init(config) {
		// 初始化相关配置
		if (config !== undefined) _store__WEBPACK_IMPORTED_MODULE_2__["default"].set('config', config);
		// 获取用户系统信息
 ...
 */
const getUserInfo = () =>
	_src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].getUserInfo({
		success(res) {},
	});
...
const getUserIpAddress = () =>
	_src_platform__WEBPACK_IMPORTED_MODULE_0__["default"].request({
...
//# sourceMappingURL=index.wx.js.map